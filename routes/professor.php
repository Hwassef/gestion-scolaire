...
Route::get('/professor/time_schedule', [\App\Http\Controllers\Professor\ConsultTimeScheduleController::class, 'displayTimeSchedule'])->name('professor.displayTimeSchedule');
